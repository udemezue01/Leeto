...
const tours = ref([
  {
    id: 1,
    title: 'Sacred Valley Secrets & Machu Picchu Sunrise Expedition',
    location: 'Cusco, Peru',
  ...
  {
    id: 2,
    title: 'Rio Sunset, Samba Heritage & Local Favela Culture Walk',
  ...
  {
    id: 3,
    title: 'Hidden Parrilla Food Tour & Underground Tango Club',
  ...
  {
    id: 4,
    title: 'Medellín Transformation: Street Art & Cable Car Secrets',
  ...
  {
    id: 5,
    title: 'Patagonia Ice Trekking & Glacial Lagoon Hike',
