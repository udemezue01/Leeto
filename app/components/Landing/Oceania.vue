...
const tours = ref([
  {
    id: 1,
    title: 'Sydney Harbour Hidden Beaches & Secret Coastal Walk',
  ...
  {
    id: 2,
    title: 'Glowworm Caves & Geothermal Springs Bush Walk',
  ...
  {
    id: 3,
    title: 'Great Barrier Reef Snorkel with Marine Biologist',
  ...
  {
    id: 4,
    title: 'Fijian Village Cultural Walk & Traditional Feast',
    location: 'Suva, Fiji',
    image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80',
    category: 'Culture & Island Life',
    rating: 4.94,
    reviewsCount: 92,
    duration: '4.5 hrs',
    price: 70,
  ...
  {
    id: 5,
    title: 'Blue Mountains Lookout Sunset Trek & Wildlife Safari',
      ...
      <div class="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
        <div>
          ...
          <p class="mt-2 text-sm sm:text-base text-zinc-600 max-w-xl">
            Book trusted local guides for coastal treks, reef snorkeling, geothermal walks, and island village encounters.
          </p>
        </div>
