...
const scrollToSection = (id) => {
  ...
  if (element) {
    // Scroll to the element with a slight offset for the sticky header
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      <div class="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4 border-b border-zinc-200/80 pb-6">
        <div>
          ...
          <p class="font-sans text-zinc-600 mt-1.5 text-sm sm:text-base font-medium">Transparency on how we collect and use data to improve your travel experience.</p>
        </div>
        ...
        <div class="flex items-center gap-4 text-xs font-semibold text-zinc-600 bg-white px-4 py-3 rounded-2xl border border-zinc-200/80 shadow-sm shrink-0">
          <div class="flex items-center gap-2">
            ...
            <span class="font-sans">Last Updated: August 21, 2026</span>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <aside class="lg:col-span-1 hidden lg:block sticky top-8">
          <div class="bg-white rounded-3xl border border-zinc-200/80 shadow-xl shadow-zinc-200/50 p-6 space-y-6">
            ...
            <div class="flex items-center gap-2.5 border-b border-zinc-100 pb-4">
              ...
              <h3 class="font-heading font-bold text-zinc-900 text-base">In this policy</h3>
            </div>
            ...
            <nav class="space-y-1">
              <button 
                ...
                :class="[
                  'font-heading w-full text-left px-4 py-2.5 rounded-xl text-sm font-bold transition-all duration-200',
            ...
            <div class="pt-4 border-t border-zinc-100">
              <button class="font-sans w-full py-3 px-4 bg-zinc-900 hover:bg-emerald-600 text-white text-xs font-bold rounded-xl flex items-center justify-center gap-2 transition duration-200 shadow-md">
        ...
        <main class="lg:col-span-2 space-y-8">
          ...
          <div class="bg-white rounded-3xl border border-zinc-200/80 shadow-md p-6 sm:p-10 text-zinc-600 font-sans font-medium text-sm sm:text-base leading-relaxed space-y-12">

            <section id="introduction" class="scroll-mt-8 space-y-4">
              <h2 class="font-heading text-2xl font-black text-zinc-900 tracking-tight flex items-center gap-3">
                <span class="font-heading flex items-center justify-center w-8 h-8 rounded-lg bg-emerald-100 text-emerald-700 text-sm">1</span>
                What are Cookies?
              </h2>
              <p>
            ...
            <section id="how-we-use" class="scroll-mt-8 space-y-4">
              <h2 class="font-heading text-2xl font-black text-zinc-900 tracking-tight flex items-center gap-3">
                <span class="font-heading flex items-center justify-center w-8 h-8 rounded-lg bg-emerald-100 text-emerald-700 text-sm">2</span>
                How We Use Cookies
              </h2>
            ...
            <section id="types-of-cookies" class="scroll-mt-8 space-y-6">
              <h2 class="font-heading text-2xl font-black text-zinc-900 tracking-tight flex items-center gap-3">
                <span class="font-heading flex items-center justify-center w-8 h-8 rounded-lg bg-emerald-100 text-emerald-700 text-sm">3</span>
                Types of Cookies We Use
              </h2>
              
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="bg-stone-50 border border-zinc-200/80 rounded-2xl p-5">
                  <h4 class="font-heading text-zinc-900 font-bold mb-2 flex items-center gap-2">
            ...
            <section id="third-party" class="scroll-mt-8 space-y-4">
              <h2 class="font-heading text-2xl font-black text-zinc-900 tracking-tight flex items-center gap-3">
                <span class="font-heading flex items-center justify-center w-8 h-8 rounded-lg bg-emerald-100 text-emerald-700 text-sm">4</span>
                Third-Party Cookies
              </h2>
              <p>
            ...
            <section id="manage-preferences" class="scroll-mt-8 space-y-4">
              <h2 class="font-heading text-2xl font-black text-zinc-900 tracking-tight flex items-center gap-3">
                <span class="font-heading flex items-center justify-center w-8 h-8 rounded-lg bg-emerald-100 text-emerald-700 text-sm">5</span>
              ...
              <div class="mt-6 p-6 bg-emerald-50/50 border border-emerald-100 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                  <h4 class="font-heading font-bold text-zinc-900">Cookie Preference Center</h4>
                  <p class="text-xs text-zinc-500 mt-1 font-sans">Review and update your current cookie consents.</p>
                </div>
                <button class="font-sans w-full sm:w-auto px-6 py-2.5 bg-zinc-900 hover:bg-emerald-600 text-white text-sm font-bold rounded-xl transition duration-200 shrink-0 shadow-md">
                  Update Settings
                </button>
              </div>
            ...
            <section id="updates" class="scroll-mt-8 space-y-4">
              <h2 class="font-heading text-2xl font-black text-zinc-900 tracking-tight flex items-center gap-3">
                <span class="font-heading flex items-center justify-center w-8 h-8 rounded-lg bg-emerald-100 text-emerald-700 text-sm">6</span>
                Updates & Contact
              </h2>
              <p>
              ...
              <div class="mt-6 p-6 bg-zinc-900 text-white rounded-2xl">
                <h4 class="font-heading font-bold text-white mb-2">Have questions?</h4>
                <p class="text-sm text-stone-300 mb-4 font-sans">
                  If you have any questions about our use of cookies or other technologies, please contact our privacy team.
                </p>
                <a href="mailto:privacy@leeto.com" class="font-sans inline-flex items-center gap-2 px-4 py-2 bg-stone-800 hover:bg-emerald-600 border border-zinc-700 rounded-xl text-sm font-bold transition-colors duration-200">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4">
